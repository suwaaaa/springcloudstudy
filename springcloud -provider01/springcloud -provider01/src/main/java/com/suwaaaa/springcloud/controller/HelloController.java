...
public class HelloController {
	...
	public User getUser(@RequestParam("name")    String name,
		...
		System.out.println(address+"---"+name+"---"+phone+"---"+"provider 001"+"---" + new Date()+"---" + "/service/postUser");
	...
	public User putUser(@RequestParam("name")    String name,
		...
		System.out.println(address+"---"+name+"---"+phone+"---"+"provider 001" +"---"+ new Date()+"---"+"/service/putUser");
	...
	public User deleteUser(@RequestParam("name")    String name,
		...
		System.out.println(address+"---"+name+"---"+phone+"---"+"provider 001"+"---" + new Date()+"---" + "/service/deleteUser");
